...
You have the best of both worlds. React Libraries, and Vert.x backend. Fast and Beautiful!

## As of March 2025 - If you need to use TypeScript, it is impractical. However JSX works!
### Typescript Problems
* Using Typescript:
